  ...
  return (
    <div className="relative z-10 space-y-8">
      <div>
        ...
        <p className="text-gray-400 mt-1">Select your request type, team, and cloud provider</p>
      </div>
          ...
          {REQUEST_TYPES.map((rt) => {
            ...
            return (
              <button
                key={rt.id}
                type="button"
                onClick={() => setForm({ ...form, requestType: rt.id })}
                className={`
          ...
          {CLOUD_PROVIDERS.map((cp) => {
            ...
            return (
              <button
                key={cp.id}
                type="button"
                onClick={() => setForm({ ...form, cloudProvider: cp.id, region: '', subscriptionId: '' })}
                className={`
